...
class BrokenResource extends AbstractCheck
{
    ...
    {
        return 'children_broken_resources';
    }
    ...
    {
        return "Page has links to broken resources";
    }

    public function getGridColumnLabel(): string
    {
        return "Linked broken resources";
    }
    ...
    public function getCheckResult(UrlInterface $url): array
    {
        $urls = $this->urlRepository->getCollection()
            ...
            ->addFieldToFilter(UrlInterface::TYPE, ['in' => $this->urlService->getResourcePageTypes()]);
