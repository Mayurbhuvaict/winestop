...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Winestop_Testimonials::Testimonials')
            ->addBreadcrumb(__('Winestop Testimonials'), __('Winestop Testimonials'))
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('Winestop_Testimonials::testimonials');
        $resultPage->addBreadcrumb(__('Winestop'), __('Winestop'));
