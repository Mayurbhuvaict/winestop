...
class CartCheckoutLogo  extends \Magento\Theme\Block\Html\Header\Logo
{
    private $cnf;
    ...
    public function getCartCheckoutLogoSrc($cnfName = 'cart_checkout_logo_image', $cnfStatus='cart_checkout_logo_status')
    {
