...
class Usps
{
    ...
    public function afterCollectRates(
        \Magento\Usps\Model\Carrier $subject,
        $result,
        ...
        if ($address) {
            ...
            $stateShipping = $this->scopeConfig->getValue('carriers/usps/specificstate');
            $countryShipping = $this->scopeConfig->getValue('carriers/usps/ictspecificcountry');
            $shipAll = $this->scopeConfig->getValue('carriers/usps/sallowspecific');
